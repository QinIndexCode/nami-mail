      ...
      <section className="agent-main-panel">
        <header className="agent-workspace-header">
          ...
          <div className="agent-header-actions">
            ...
            <button className="agent-workspace-back" type="button" onClick={onClose} aria-label={t("agent.workspace.close")} data-tooltip={t("agent.workspace.close")}><ArrowLeft size={15} />{t("agent.workspace.backToMail")}</button>
          </div>
        </header>
