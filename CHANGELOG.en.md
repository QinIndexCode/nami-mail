...
- Added local MCP stdio access via `namimail mcp start --profile <name>`: it uses MCP protocol `2025-03-26` and publishes fifteen External Mail v1 tools from `tools/list` (eight read-only plus seven bounded writes).
