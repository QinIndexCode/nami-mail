...
- 使用前先阅读 [README](README.md)、[隐私与本地数据说明](docs/PRIVACY.zh-CN.md)、[安全策略](SECURITY.zh-CN.md)、[社区行为准则](CODE_OF_CONDUCT.zh-CN.md) 和 [本地化说明](docs/LOCALIZATION.zh-CN.md)。
- 漏洞、凭据泄露、可能读取其他用户邮件的路径，不要开公开 Issue；按 [SECURITY.zh-CN.md](SECURITY.zh-CN.md) 的流程私下报告。
