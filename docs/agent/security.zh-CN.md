...
- CLI/MCP 使用已配对的当前用户 SID DACL 命名管道；Broker 绑定 host/boot 身份、递增计数、签名证明和重放检查。
...
参见 [RAG 故障排查](../rag/troubleshooting.zh-CN.md) 和 [发布检查清单](../development/release-checklist.zh-CN.md)。
