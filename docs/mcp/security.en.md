...
| --- | --- | --- |
| `read-only` | The nine read-only tools only (account, folder, message search, message digest, single and batch message read, thread, attachment metadata). | None. |
